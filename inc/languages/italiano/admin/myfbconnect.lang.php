...
$l['myfbconnect_settings_verifiedonly'] = "Solo account verificati";
$l['myfbconnect_settings_verifiedonly_desc'] = "Abilita quest'opzione per permettere solamente agli utenti verificati di registrarsi con Facebook. Gli utenti verificati sono quelli che hanno confermato il proprio account o con un SMS o registrandosi via cellulare: sono persone sicuramente reali. L'opzione è disabilita di default ma se desideri restringere l'accesso per evitare registrazioni di entità elettroniche (bot) indesiderate puoi abilitarla. Gli utenti non verificati non potranno registrarsi e verrà mostrata una pagina d'errore al posto del normale percorso di registrazione.";
