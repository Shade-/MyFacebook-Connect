...
$l['setting_myfbconnect_fastregistration_desc'] = "If this option is disabled, when an user wants to register with Facebook he will be asked for permissions for your app if it's the first time he is loggin in, else he will be registered and logged in immediately without asking for username changes and what data to sync.";
$l['setting_myfbconnect_usergroup'] = "After registration usergroup";
$l['setting_myfbconnect_usergroup_desc'] = "Enter the usergroup ID you want the new users to be when they register with Facebook. By default this value is set to 2, which equals to Registered usergroup.";
...
$l['setting_myfbconnect_passwordpm_fromid_desc'] = "Insert the UID of the user who will be the sender of the PM. By default is set to 0 which is MyBB Engine, but you can change it to whatever you like.";
